  ...
  return (
    <div className="relative w-full max-w-2xl mx-auto">
      <form onSubmit={handleSubmit} className="relative">
        <div className="relative bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl border border-white/50 hover:shadow-2xl transition-all duration-300">
          <input
            type="text"
            value={query}
            ...
            className="w-full px-6 py-5 pl-16 pr-32 bg-transparent rounded-2xl text-gray-800 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-400/50 transition-all duration-300 text-lg font-medium"
            disabled={loading}
          />
          ...
          <div className="absolute right-3 top-1/2 transform -translate-y-1/2 flex items-center gap-2">
            <button
              ...
              disabled={loading}
              className="p-3 text-gray-500 hover:text-blue-600 hover:bg-blue-50 rounded-xl transition-all duration-200 disabled:opacity-50 hover:scale-110 group"
      ...
      {showRecent && recentSearches.length > 0 && (
        <div className="absolute top-full left-0 right-0 mt-3 bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl border border-white/50 z-50 overflow-hidden">
          ...
          <div className="max-h-52 overflow-y-auto">
            {recentSearches.map((city, index) => (
              <button
                ...
                className="w-full px-4 py-3 text-left hover:bg-gradient-to-r hover:from-blue-50 hover:to-purple-50 transition-all duration-200 text-gray-700 font-medium hover:translate-x-2 flex items-center gap-3 group"
              >
